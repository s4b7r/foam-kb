...
- [Python](#python)
	...
	- [pylint](#pylint)
		- [Nachrichten zeilenweise deaktivieren](#nachrichten-zeilenweise-deaktivieren)
...
### Nachrichten zeilenweise deaktivieren

Kommentar an die Zeile anhängen:

```py
#pylint: disable=MSG-NUMBER
```

Funktioniert auch für gesamte Blöcke, wenn der Kommentar an den Anfang des Blocks geschrieben wird. 
